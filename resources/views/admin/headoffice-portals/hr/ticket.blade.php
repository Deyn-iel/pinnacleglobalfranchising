...
<head>
    ...
    <meta name="chat-department" content="hr">
    ...
    <main>
        ...
        <div class="page-header">
            <div>
                ...
                <br>
                <a href="{{ route('tickets.myTickets', ['from' => 'hr']) }}"
                ...
                <div class="user-header">
                    <div>
                        <h5>
                            ...
                            <button type="button" class="btn btn-sm btn-dark ms-2 position-relative"
                                ...
                                <tr>
                                    ...
                                    <td class="concern-cell">
                                        <div class="concern-row">
                                            ...
                                            <button type="button" class="btn btn-sm btn-view view-ticket"
                                                ...
                                                data-priority="{{ ucfirst($ticket->priority) }}" {{-- @php
                                    ...
                                    <td class="text-center">
                                        <div class="action-wrap dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end action-menu">
                                                ...
                                                <button type="button" class="btn btn-sm btn-warning request-approval"
                                                    data-ticket-id="{{ $ticket->id }}"
                                                    title="Request user confirmation"
                                                    {{ $isReview ? 'disabled' : '' }}>
                                                    <i
                                                        class="fa-solid {{ $isReview ? 'fa-hourglass-half' : 'fa-paper-plane' }}"></i>
                                                    {{ $isReview ? 'Requesting' : 'Request' }}
                                                </button>

                                                @php
                                                    $isLocked =
                                                        $ticket->status === 'resolved' || $ticket->approval_requested;
                                                @endphp

                                                <button type="button" class="btn btn-sm btn-info transfer-ticket"
                                                    data-ticket-id="{{ $ticket->id }}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="text-muted mb-2"
                            style="font-weight:900; font-size:12px; letter-spacing:.06em; text-transform:uppercase;">
                            Concern Details
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <textarea id="approvalJustification" class="form-control" rows="4"
            ...
            async function handleApproval() {
                ...
                try {
                    ...
                    const res = await fetch(
                        `/admin/headoffice-portals/tickets/${selectedTicketId}/request-approval`, {
                            method: "POST",
                            headers: {
                                "X-CSRF-TOKEN": CSRF,
                                "Accept": "application/json"
                ...
                try {
                    ...
                    tickets.forEach(ticket => {
                        ...
                        const row = document.querySelector(
                            `.request-approval[data-ticket-id="${ticket.id}"]`)?.closest("tr");
                        if (!row) return;
                        ...
                        if (approvalBtn) {
                            ...
                            if (ticket.approval_requested) {
                                ...
                                approvalBtn.innerHTML =
                                    `<i class="fa-solid fa-hourglass-half"></i> Requesting`;
                    ...
                    if (transfer) {
                        ...
                        Object.entries(allDepts).forEach(([key, label]) => {
                            ...
                            if (key === currentDept) {
                                ...
                                select.innerHTML +=
                                    `<option value="${key}" disabled>${label} (Current)</option>`;
                            } else {
                                // normal options
