...
<head>
    ...
    <title>Admin Secretary Dashboard</title>
    ...
    <main>
        ...
        <div class="page-header">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div>
                    <h3>Admin Secretary Dashboard</h3>
                ...
                <div class="stat-card">
                    <div>
                        ...
                        <div class="stat-value">
                            {{ \App\Models\Ticket::where('department', 'admin-secretary')->count() }}</div>
                    </div>
                    <div class="stat-icon">
                ...
                <table class="table align-middle">
                    ...
                    @php
                        ...
                        $tickets = Ticket::with('user')
                            ->where('department', 'admin-secretary')
                            ->latest()
                            ->take(5)
                            ->get();
                    @endphp
