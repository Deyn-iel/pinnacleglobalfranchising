                ...
                <form method="POST" action="{{ route('admin.attendance.location.update') }}">
                    ...
                    <div class="row g-3 align-items-end">
                        <div class="col-12 col-md-6 col-lg-4">
                            ...
                            <input type="number" step="0.0000001" name="lat" value="{{ $setting->lat ?? '' }}"
                                class="form-control" required>
                        </div>

                        <div class="col-12 col-md-6 col-lg-4">
                            <label class="form-label">Longitude</label>
                            <input type="number" step="0.0000001" name="lng" value="{{ $setting->lng ?? '' }}"
                                class="form-control" required>
                        </div>

                        <div class="col-12 col-md-6 col-lg-2">
                            <label class="form-label">Radius (meters)</label>
                            <input type="number" name="radius" value="{{ $setting->radius ?? 100 }}"
                                class="form-control" required>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <img id="selfieModalImg"src="{{ asset('storage/' . $selfie) }}"
                        class="img-fluid rounded selfie-img" alt="Selfie">
                </div>
            </div>
        </div>
    </div>
