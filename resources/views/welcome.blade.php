...
<head>
    ...
    <title>Pinnacle Global Franchising</title>
        ...
        <div class="step">
            <div class="ring-wrap">
                <div class="ring ring-1">
                    <span>01<br><small>STEP</small></span>
                </div>
            </div>
            <div class="step-text">
                <h4>Submit Franchise Application</h4>
        ...
        <div class="step">
            <div class="ring-wrap">
                <div class="ring ring-2">
                    <span>02<br><small>STEP</small></span>
                </div>
            </div>
            <div class="step-text">
                <h4>Franchise Orientation</h4>
        ...
        <div class="step">
            <div class="ring-wrap">
                <div class="ring ring-3">
                    <span>03<br><small>STEP</small></span>
                </div>
            </div>
            <div class="step-text">
        ...
        <div class="step">
            <div class="ring-wrap">
                <div class="ring ring-4">
                    <span>04<br><small>STEP</small></span>
                </div>
            </div>
            <div class="step-text">
                <h4>Site Preparation & Training Program</h4>
        ...
        <div class="step">
            <div class="ring-wrap">
                <div class="ring ring-5">
                    <span>05<br><small>STEP</small></span>
                </div>
            </div>
            <div class="step-text">
                <h4>Pre-Opening Assistance</h4>
        ...
        <div class="step">
            <div class="ring-wrap">
                <div class="ring ring-6">
                    <span>06<br><small>STEP</small></span>
                </div>
            </div>
            <div class="step-text">
                <h4>Grand Opening & Continuous Support</h4>
