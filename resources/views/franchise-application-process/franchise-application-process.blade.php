...
<head>
    ...
    @vite(['resources/css/franchise-app/app.css', 'resources/js/franchise-app/app.js', 'resources/js/app.js'])
</head>
...
<body>
    ...
    <div class="container">
        ...
        <form action="{{ route('franchise.submit') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
                <p>
                    At Kape-Ilokano, we take pride in sharing the rich flavors of Ilokano coffee culture. With over
                    <b>18 partners nationwide</b>, we continue to grow, bringing the authentic taste of locally sourced
