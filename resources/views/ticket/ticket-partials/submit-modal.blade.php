            ...
            <div class="modal-body p-4">
                ...
                <form id="ticketForm" method="POST" action="{{ route('tickets.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ ucwords(strtolower(Auth::user()->name)) }}"
                            style="background-color: transparent;" disabled>

                        <input type="hidden" name="branch" value="{{ ucwords(strtolower(Auth::user()->name)) }}">
                    </div>
                    <!-- DESCRIPTION -->
                    <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <button type="button" class="btn btn-dark btn-sm p-2 fw-semibold" style="border-radius: 15px;"
                            data-bs-dismiss="modal"> Cancel
                        </button>

                        <button id="submitBtn" type="submit" class="btn btn-dark btn-sm p-2 fw-semibold"
