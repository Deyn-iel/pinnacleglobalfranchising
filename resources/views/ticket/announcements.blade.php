...
<body>
    ...
    <script>
        ...
        const announcementsData = [{
                id: 1,
                title: "📢 New Support Portal Features",
                description: "We've launched AI-powered smart routing and real-time chat translation. Check the new knowledge base integration.",
                date: "2025-04-05",
            ...
            },
            {
                ...
                description: "Platform will undergo scheduled maintenance on April 12th from 2:00 AM - 4:00 AM EST. Expect brief downtime.",
                date: "2025-04-02",
            ...
            {
                id: 3,
                title: "🏆 Team of the Month: Support Heroes",
                description: "Congratulations to our Customer Success team for outstanding CSAT scores! Celebrating excellence.",
                date: "2025-03-28",
            ...
            {
                id: 4,
                title: "📅 Webinar: Advanced Dashboard Tips",
                description: "Join us April 15th for a live walkthrough of analytics and announcement automation.",
                date: "2025-03-25",
                category: "Event",
                highlight: true
            }
        ...
        const ticketsData = [{
                id: "TK-1023",
                title: "Login timeout for EU region",
                status: "open",
                priority: "high",
                date: "2025-04-06"
            },
            ...
            {
                id: "TK-1101",
                title: "Unable to attach files to announcement",
                status: "open",
                priority: "high",
                date: "2025-04-07"
            },
            {
                id: "TK-1112",
                title: "Notification bell not showing unread count",
                status: "resolved",
                priority: "low",
                date: "2025-04-03"
            }
        ...
        function showNotificationToast() {
            ...
            bell.innerHTML =
                '<i class="fas fa-bell" style="color:#0d3553;"></i><span style="position:absolute; margin-top:-8px; margin-left:12px; background:#ef4444; color:white; font-size:10px; border-radius:20px; padding:2px 5px;">3</span>';
            setTimeout(() => {
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function toggleSidebar() {
                sidebar.classList.contains("mobile-closed") ? openSidebar() : closeSidebar();
            }
