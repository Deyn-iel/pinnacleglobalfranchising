            ...
            <div id="dashboardPanel">
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <div class="stat-value">{{ \App\Models\Ticket::where('user_id', Auth::id())->count() }}</div>
                        <span class="stat-trend" style="color:#2d9c6b;"><i class="fas fa-chart-line"></i> Submitted</span>
                    </div>
                    

                    <div class="stat-card">
                        <div class="stat-title">Pending</div>
                        <div class="stat-value">{{ \App\Models\Ticket::where('user_id', Auth::id())->where('status', 'pending')->count() }}</div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value">{{ \App\Models\Ticket::where('user_id', Auth::id())->where('status', 'in_progress')->count() }}</div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value">{{ \App\Models\Ticket::where('user_id', Auth::id())->whereMonth('resolved_at', now()->month)->count() }}</div>
                        @php
